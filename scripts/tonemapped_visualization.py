...
ref_dir = "/home/jiaqitang/HDR_all/A_Dataset/SYS_Full_NTIRE/Val/GT"
ref_alignratio_dir = '/home/jiaqitang/HDR_all/A_Dataset/SYS_Full_NTIRE/Val/alignratio'
# res_dir = './Visualization/medium'
# res_alignratio_dir = ref_alignratio_dir
res_dir = '/home/jiaqitang/HDR_all/Final_Ours/results/Ours-Original/input'
res_alignratio_dir = '/home/jiaqitang/HDR_all/Final_Ours/results/Ours-Original/restore'

ref_output_dir = '/home/jiaqitang/HDR_all/Final_Ours/Visualization2/tone_mapped_gt'
# res_output_dir = './Validation/tone_mapped_medium'
res_output_dir = '/home/jiaqitang/HDR_all/Final_Ours/Visualization2/tone_mapped_results_ours'
...
for filename in sorted(os.listdir(ref_dir)):
    ...
    res_image = io.imread_uint16_png(osp.join(res_dir, "{:04d}.png".format(
        image_id)), osp.join(res_alignratio_dir, "{:04d}_alignratio.npy".format(image_id)))
    res_linear_image = res_image ** 2.24
    res_image = (m.tanh_norm_mu_tonemap(res_linear_image,
                 norm_perc) * 255.).round().astype(np.uint8)
    cv2.imwrite(osp.join(res_output_dir, "{:04d}_tone_mapped_result.png".format(
