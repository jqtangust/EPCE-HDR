...
from models.customize_loss import tanh_L1Loss, tanh_L2Loss, tanh_L1Loss_Entropy
...
class GenerationModel(BaseModel):
    def __init__(self, opt,tb_logger):
        ...
        if self.is_train:
            ...
            elif loss_type == 'tanh_l1_Entropy':
                self.cri_pix = tanh_L1Loss_Entropy().to(self.device)
            else:
